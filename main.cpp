        ...
        if ((found != string::npos) && (found < 50)) {
            ...
            if (found1 != string::npos) {
                ...
                if (found1 != string::npos) {
                    ...
                    oline = oline + "INC #(.DATAWIDTH" + z_dw[0] + ") INC_" + std::to_string(count_DPC[10]) + "(.a(" +
                            x + "), .d(" + z + ")); \n";
                } else {
                    str = iline;
                    (x, y, z) = iovalues(str, x, y, z);
                    ...
                    oline = oline + "ADD #(.DATAWIDTH(" + z_dw[1] + ")) ADD_" + std::to_string(count_DPC[1]) + "(.a(" +
                            x + "), .b(" + y + "), .sum(" + z + ")); \n";
                }
            }
            ...
            if (found2 != string::npos) {
                ...
                if (found2 != string::npos) {
                    ...
                    oline = oline + "DEC #(.DATAWIDTH(" + z_dw[2] + ")) DEC_" + std::to_string(count_DPC[11]) + "(.a(" +
                            x + "), .d(" + z + ")); \n";
                } else {
                    str = iline;
                    (x, y, z) = iovalues(str, x, y, z);
                    ...
                    oline = oline + "SUB #(.DATAWIDTH(" + z_dw[3] + ")) SUB_" + std::to_string(count_DPC[2]) + "(.a(" +
                            x + "), .b(" + y + "), .diff(" + z + ")); \n";
                }
            }
            ...
            if (found3 != string::npos) {
                ...
                oline = oline + "MUL #(.DATAWIDTH(" + z_dw[4] + ")) MUL_" + std::to_string(count_DPC[3]) + "(.a(" + x +
                        "), .b(" + y + "), .prod(" + z + ")); \n";
                temp = 3;
            }
            ...
            if (found4 != string::npos) {
                ...
                oline = oline + "DIV #(.DATAWIDTH(" + z_dw[5] + ")) DIV_" + std::to_string(count_DPC[8]) + "(.a(" + x +
                        "), .b(" + y + "), .quot(" + z + ")); \n";
                temp = 4;
            }
            ...
            if (found5 != string::npos) {
                ...
                oline = oline + "MOD #(.DATAWIDTH(" + z_dw[6] + ")) MOD_" + std::to_string(count_DPC[9]) + "(.a(" + x +
                        "), .b(" + y + "), .rem(" + z + ")); \n";
                temp = 5;
            }
            ...
            if (found6 != string::npos) {
                ...
                oline = oline + "SHL #(.DATAWIDTH(" + z_dw[7] + ")) SHL_" + std::to_string(count_DPC[7]) + "(.a(" + x +
                        "), .sh_amt(" + y + "), .d(" + z + ")); \n";
                temp = 6;
            }
            ...
            if (found7 != string::npos) {
                ...
                oline = oline + "SHR #(.DATAWIDTH(" + z_dw[8] + ")) SHR_" + std::to_string(count_DPC[6]) + "(.a(" + x +
                        "), .sh_amt(" + y + "), .d(" + z + ")); \n";
                temp = 7;
            }
            ...
            if (found9 != string::npos) {
                ...
                oline = oline + "COMP #(.DATAWIDTH(" + z_dw[10] + ")) COMP_" + std::to_string(count_DPC[4]) + "(.a(" +
                        x + "), .b(" + y + "), .eq(" + z + ")); \n";
                temp = 9;
            }
            ...
            if ((found10 != string::npos) && (temp != 6)) {
                ...
                count_DPC[4]++;                            //count instances of COMP
                oline = oline + "COMP #(.DATAWIDTH(" + z_dw[11] + ")) COMP_" + std::to_string(count_DPC[4]) + "(.a(" +
                        x + "), .b(" + y + "), .lt(" + z + ")); \n";
                temp = 10;
            }
            ...
            if ((found11 != string::npos) && (temp != 7)) {
                ...
                count_DPC[4]++;                            //count instances of COMP
                oline = oline + "COMP #(.DATAWIDTH(" + z_dw[12] + ")) COMP_" + std::to_string(count_DPC[4]) + "(.a(" +
                        x + "), .b(" + y + "), .gt(" + z + ")); \n";
                temp = 11;
            }
            if ((found != string::npos) && (temp == 0))        //select REG
            {
                ...
                if (error == 1) {
                    ...
                    oline = oline + "REG #(.DATAWIDTH(" + strv + ")) REG_" + std::to_string(count_DPC[0]) + "(.d(" + x +
                            "), .Clk(1), .Rst(0), .q(" + z + ")); \n";
                }
            }
        }
